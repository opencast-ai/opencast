        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="relative overflow-hidden rounded border border-white/10 bg-surface-dark p-5 group hover:border-primary/30 transition-colors">
            ...
            <div className="flex items-center justify-between mb-1">
              <p className="text-text-muted text-xs font-mono uppercase tracking-wider">Total Equity (balance + positions)</p>
              ...
              {session.isHuman && (
                <>
                  <button
                    ...
                    className="h-7 px-3 bg-primary/90 hover:bg-primary text-white text-[10px] font-mono uppercase tracking-wide rounded-sm flex items-center gap-1 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="h-7 px-3 border border-white/20 hover:border-white/40 bg-white/5 hover:bg-white/10 text-white text-[10px] font-mono uppercase tracking-wide rounded-sm flex items-center gap-1 transition-colors"
                  >
